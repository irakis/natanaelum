    ...
    return (
        <div className={clsx('row', styles.myContainer)}>
                ...
                <div className={clsx('col-5')}>
                    <div className='row d-block h-100'>
                        ...
                        <div className='col-12 mt-4 d-flex justify-content-end '>
                            <p className='text-right'>powstało z inicjatywy pracowników Instytutu Psychologii Katolickiego Uniwersytetu Lubelskiego Jana Pawło II. 
                                Do istnienie powołane sostało na zebraniu załozycielskim w dniu 20.12.2010 roku w Lublinie.
            ...
            <div className='row d-flex flex-nowrap'>
                <div className='col-9'>
                    <p className={clsx(styles.middle)}>Współprace:</p>
                </div>
            </div>
            ...
            <div className={clsx('row', styles.about)}>
                <div className={clsx(styles.butterflyParent,'col-6 p-0 position-relative')}>
                    <img className={clsx(styles.butterflyBlue, 'position-absolute')} src={`${process.env.PUBLIC_URL}/images/about/Motyl niebieski 1.png`} alt='motyl_niebieski_1'/>
                </div>
                    ...
                    <div className='row d-block h-100'>
                        ...
                        <div className='col-12 mt-4 d-flex '>
                            <p>Psychoprofilaktyki i Psychoterapii IPIP, powołany do życia w ramach działań statutowych Stowarzyszenia NATANAELUM w dniu 1 czerwca 2011 roku, ma za zadanie dostarczanie merytorycznego wsparcia osobom i instytucjom, które działają 
                                na rzecz grup i jednostek zagrożonych wykluczeniem społecznym. W szczególności, Instytut koncentruje się na wspieraniu osób uzależnionych od substancji psychoaktywnych i czynności, poprzez prowadzenie badań naukowych 
                        ...
                        <div className='col-12 mt-5 mb-5 pb-5 d-flex justify-content-end'>
                            <div>
